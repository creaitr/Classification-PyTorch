...
def set_model(cfg):
    ...
    if data in ['cifar10', 'cifar100']:
        ...
        model = RexNetV1_CIFAR(width_mult=cfg.width_mult, classes=num_classes)
        
    elif data == 'imagenet':
        image_size = 224
        num_classes = 1000
        model = RexNetV1(width_mult=cfg.width_mult, classes=num_classes)

    else:
        raise Exception('Undefined dataset for ReXNet architecture.')
